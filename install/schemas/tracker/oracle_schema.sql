...
CREATE TABLE phpbb_tracker_project (
	...
	project_security number(1) DEFAULT '0' NOT NULL,
	ticket_security number(1) DEFAULT '0' NOT NULL,
	show_php number(1) DEFAULT '0' NOT NULL,
	show_dbms number(1) DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_tracker_tickets (
	...
	ticket_status number(1) DEFAULT '0' NOT NULL,
	ticket_hidden number(1) DEFAULT '0' NOT NULL,
	ticket_security number(1) DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_tracker_version (
	...
	version_enabled number(1) DEFAULT '1' NOT NULL,
